...
//go:generate go build -buildmode=c-shared -o ../print.a print.go

//export  GoPrint
func GoPrint(name string) {
	fmt.Printf("Bye, %s.(print by print.go)\n", name)
}
...
//
//3、第6行 //export SayBye  这里的SayBye要和下面的的go函数名一致，并且下面一行即为要导出的go函数
//
