...
import (
	"context"
	"errors"
	"github.com/xiaomLee/go-example/grpc-like-gin/api"
	"net"
	"sync"
...
func (e *GRpcEngine) newContext(ctx context.Context, key string, in *api.Request) *GRpcContext {
...
func (e *GRpcEngine) DoRequest(ctx context.Context, in *api.Request) (*api.Response, error) {
...
func (e *GRpcEngine) Run(addr string, opt ...grpc.ServerOption) (*grpc.Server, error) {
	...
	api.RegisterEndServer(gRpcSvr, e)
